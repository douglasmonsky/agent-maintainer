+++
id = "release-0.1.0b9-publication-evidence"
kind = "release"
status = "complete"
base_ref = "cbf8521"
expires = 2026-07-25
...
ratchet_targets = []
+++
# Cohesive Change Plan: release-0.1.0b9-publication-evidence
...
Only release evidence and public release pointers, the b9 and b10 adoption
records, package version metadata, the policy-required regenerated development
lock, directly coupled release fixtures, DocSync traceability records, and this
change plan may change.

## What must not change

Do not alter runtime behavior, dependencies, publishing workflows, package
artifacts, the immutable b9 tag, release assets, or package-index state. Do not
claim b10 features or publication evidence that do not exist.
...
incorrect. The already published b9 artifacts and immutable tag remain intact;
...
Keep b10 intent-only until its roadmap scope is implemented and verified.
