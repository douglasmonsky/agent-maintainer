...
allowed_paths = [
  ...
  "docs/ratcheting.md",
  "docs/roadmap/future-call-roi-acceleration.md",
  ...
  "src/agent_maintainer/assess/baseline_cli.py",
  "src/agent_maintainer/assess/baseline_repository.py",
  "src/agent_maintainer/assess/file_baseline_codec.py",
  "src/agent_maintainer/assess/file_baselines.py",
  "src/agent_maintainer/assess/file_baseline_lifecycle.py",
  "src/agent_maintainer/assess/file_baseline_state.py",
  "src/agent_maintainer/assess/models.py",
  "src/agent_maintainer/assess/reporting.py",
  "src/agent_maintainer/assess/java_baselines.py",
  "src/agent_maintainer/assess/java_baseline_evidence.py",
  ...
  "tests/assess/test_file_ceiling_baseline.py",
