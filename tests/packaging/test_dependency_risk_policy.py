...
DEV_DEPENDENCIES = REPO_ROOT / "config" / "dev-dependencies.in"
...
def test_python_dev_lock_has_resolver_provenance() -> None:
    ...
    assert DEV_DEPENDENCIES.suffix == ".in"
    ...
    assert "config/dev-dependencies.in pyproject.toml" in lock
    assert "# via -r config/dev-dependencies.in" in lock
