...
from ai_guardrails.config.schema import GITLEAKS_SCANNER, GuardrailConfig
from ai_guardrails.runners.secret_scan import (
    CURRENT_TREE_MODE,
    HISTORY_MODE,
    RANGE_MODE,
    STAGED_MODE,
...
def secret_scan_check(
    ...
    command = [
        sys.executable,
        "-m",
        "ai_guardrails.runners.secret_scan",
        "--backend",
    ...
    return models.Check(
        ...
        command,
        frozenset((profile,)),
        required_paths=("src/ai_guardrails/runners/secret_scan.py",),
