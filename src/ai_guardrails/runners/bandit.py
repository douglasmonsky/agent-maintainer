...
from ai_guardrails.core.config import load_config
from ai_guardrails.core.executor import command_env
...
def main() -> int:
    """Run Bandit using guardrail settings and write the JSON artifact."""
