...
def context_file(
    ...
    """Read a bounded source file slice or symbol."""
    return tools.run_tool_request(
...
MCP_TOOL_HANDLERS: tuple[ToolHandler, ...] = (
    verify,
    context_failures,
