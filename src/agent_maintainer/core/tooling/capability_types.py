"""Types and constants for maintainer tool capabilities."""
...
class ToolCapability:
    """How a maintainer tool is installed and evaluated."""
...
@dataclass(frozen=True)
class ToolState:
    """Resolved availability state for one maintainer tool."""
