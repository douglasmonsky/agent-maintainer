...
TUPLE_ENVS = (
    ...
    ("go_format_command", "AGENT_MAINTAINER_GO_FORMAT_COMMAND"),
    ("go_format_profiles", "AGENT_MAINTAINER_GO_FORMAT_PROFILES"),
    ("go_vet_command", "AGENT_MAINTAINER_GO_VET_COMMAND"),
    ("go_vet_profiles", "AGENT_MAINTAINER_GO_VET_PROFILES"),
    ("go_test_command", "AGENT_MAINTAINER_GO_TEST_COMMAND"),
    ("go_test_profiles", "AGENT_MAINTAINER_GO_TEST_PROFILES"),
...
BOOL_ENVS = (
    ...
    ("enable_go", "AGENT_MAINTAINER_ENABLE_GO"),
