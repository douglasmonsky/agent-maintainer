...
from agent_run_artifacts.models import ArtifactConfigLike, CheckResultLike
...
def result_status(result: CheckResultLike) -> str:
...
def threshold_snapshot(config: ArtifactConfigLike) -> dict[str, object]:
