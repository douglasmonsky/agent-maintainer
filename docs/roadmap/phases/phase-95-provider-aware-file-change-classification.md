...
- Reuse existing Python and TypeScript/JavaScript file classifiers.
...
- Add tests proving TypeScript/JavaScript changed files can be
...
- No TypeScript/JavaScript blocking reviewability gates.
...
- Python changed-file classification matches current source/test/generated
  root semantics.
- TypeScript/JavaScript changed-file classification is available for
...
- Tests fail if future refactors accidentally classify TypeScript/JavaScript
  changes as current blocking Python reviewability input.
...
Do not promote TypeScript/JavaScript reviewability checks to blocking
