...
`0.1.0b7` is published on PyPI with immutable release evidence. Use this guide
to adopt it from `0.1.0b6` while preserving a clean rollback point.
...
Do not copy generated files over the restored state. If a mutation
