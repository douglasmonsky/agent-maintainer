...
instead of pretending the repo is healthy.

## Categories

| Category | Signals |
|---|---|
| Reviewability | Change budget, file-count pressure, file length, and source size. |
| Tests and Coverage | Required tests, detected tests, and total coverage floor. |
| Type and Style | Pyright mode, Ruff complexity, and wemake strictness. |
| Architecture Boundaries | Tach or Import Linter config evidence. |
