...
- [x] `agent-maintainer==0.1.0b9` is published to TestPyPI and PyPI,
      attached to GitHub prerelease `v0.1.0b9`, and smoke-tested from both
      package indexes. Release evidence is recorded in
      [`docs/releases/0.1.0b9.md`](releases/0.1.0b9.md).

Current source candidate state:

- [x] The unpublished `0.1.0b10` release candidate is the package-metadata and
      main-branch documentation target. Review the
      [candidate notes](releases/0.1.0b10.md) and
      [evaluation guide](upgrading-to-0.1.0b10.md).
- [ ] `0.1.0b10` becomes the current external release only after the exact
