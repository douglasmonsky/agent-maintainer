...
> layouts.
>
> Latest published package: `agent-maintainer==0.1.0b9`, with immutable
> [release evidence](docs/releases/0.1.0b9.md). See the
> [upgrade guide](docs/upgrading-to-0.1.0b9.md) for package-index adoption and
> rollback guidance. This checkout targets the unpublished `0.1.0b10` release
> candidate; see its [candidate notes](docs/releases/0.1.0b10.md) and
> [evaluation guide](docs/upgrading-to-0.1.0b10.md).
...
[0.1.0b9 upgrade guide](docs/upgrading-to-0.1.0b9.md) for safe adoption and
rollback guidance.
...
[0.1.0b9 upgrade guide](docs/upgrading-to-0.1.0b9.md),
[0.1.0b10 candidate notes](docs/releases/0.1.0b10.md),
[0.1.0b10 evaluation guide](docs/upgrading-to-0.1.0b10.md).
